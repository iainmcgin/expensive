...
import io.demoapp.expensive.ScrollChildSwipeRefreshLayout;
import io.demoapp.expensive.data.Task;
import io.demoapp.expensive.data.source.TasksRepository;
import io.demoapp.expensive.databinding.TaskItemBinding;
import io.demoapp.expensive.databinding.TasksFragBinding;
import io.demoapp.expensive.util.SnackbarUtils;
...
public class TasksFragment extends Fragment {
    ...
    public static class TasksAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            final TaskItemViewModel viewmodel =
                    new TaskItemViewModel(mTasksViewModel.getApplication());
