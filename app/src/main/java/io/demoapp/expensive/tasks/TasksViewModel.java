...
import io.demoapp.expensive.BR;
 ...
 * getter method.
 */
public class TasksViewModel extends ObservableViewModel {
    ...
    public void setFiltering(TasksFilterType requestType) {
        ...
        switch (requestType) {
            case ALL_TASKS:
                currentFilteringLabel.set(getApplication().getString(R.string.label_all));
                noTasksLabel.set(getApplication().getResources().getString(R.string.no_tasks_all));
                noTaskIconRes.set(getApplication().getResources().getDrawable(
                        R.drawable.ic_assignment_turned_in_24dp));
                tasksAddViewVisible.set(true);
                break;
            case ACTIVE_TASKS:
                currentFilteringLabel.set(getApplication().getString(R.string.label_active));
                noTasksLabel.set(getApplication().getResources().getString(R.string.no_tasks_active));
                noTaskIconRes.set(getApplication().getResources().getDrawable(
                        R.drawable.ic_check_circle_24dp));
                tasksAddViewVisible.set(false);
                break;
            case COMPLETED_TASKS:
                currentFilteringLabel.set(getApplication().getString(R.string.label_completed));
                noTasksLabel.set(getApplication().getResources().getString(R.string.no_tasks_completed));
                noTaskIconRes.set(getApplication().getResources().getDrawable(
    ...
    public void clearCompletedTasks() {
        ...
        snackbarText.set(getApplication().getString(R.string.completed_tasks_cleared));
        ...
        if (AddEditTaskActivity.REQUEST_CODE == requestCode) {
            switch (resultCode) {
                case TaskDetailActivity.EDIT_RESULT_OK:
                    snackbarText.set(
                            getApplication().getString(R.string.successfully_saved_task_message));
                    break;
                case AddEditTaskActivity.ADD_EDIT_RESULT_OK:
                    snackbarText.set(
                            getApplication().getString(R.string.successfully_added_task_message));
                    break;
                case TaskDetailActivity.DELETE_RESULT_OK:
                    snackbarText.set(
                            getApplication().getString(R.string.successfully_deleted_task_message));
                    break;
            }
        }
    }
